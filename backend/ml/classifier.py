...
Fixed: handles singleton classes gracefully (no crash on small datasets).
"""
...
def train(descriptions: list, labels: list) -> dict:
    ...
    # Drop classes with only 1 sample — can't split them
    ...
    # Adjust test_size so every class gets at least 1 test sample
